...
Original file is located at
    https://colab.research.google.com/drive/15nonyYT13FmVh7iUYt4USHd4-lOMYY8i
...
path = path = os.getcwd() + "/datasets/preprocessed datasets"

#saving the preprocessed datasets and col_names
with open(path + "/preprocessed_ace_no_feature_selection.csv", 'w', encoding = 'utf-8-sig') as f:
  dataset["ace"].to_csv(f)
with open(path + "/preprocessed_copd_no_feature_selection.csv", 'w', encoding = 'utf-8-sig') as f:
